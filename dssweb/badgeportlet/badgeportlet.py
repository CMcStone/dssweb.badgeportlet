...
from dssweb.badgeportlet import PloneMessageFactory as _

logger = logging.getLogger('dssweb.badgeportlet')
...
class IPersonBadgePortlet(IPortletDataProvider):
    ...
    person = schema.Choice(
         title=_(u"Target collection"),
         description=_(u"Find the collection which provides the items to list"),
         required=True,
         source=CatalogSource(portal_type=('FSDPerson')),
    )
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('badgeportlet.pt')
...
class AddForm(base.AddForm):
    ...
    description = _(u"person_badge_portlet",
        default=u"This portlet displays the person badge. This form enables borders and footers.")
...
class EditForm(base.EditForm):
    ...
    """
    form_fields = form.Fields(IPersonBadgePortlet)
    label = _(u"title_edit_person_badge_portlet", default=u"Edit person badge portlet")
    description = _(u"description_personbadge_portlet",
        default=u"This portlet displays a person of any type on a page. This form enables borders and footers.")